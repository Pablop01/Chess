...
public class Coordenada implements Serializable {
	...
	/**
	 * Mueve una celda en diagonal, hacia arriba a la izquierda respecto a la que se
	 * encuentra
	 * 
	 * @return La nueva coordenada
	 */
	...
	/**
	 * Mueve una celda en diagonal, hacia arriba a la derecha respecto a la que se
	 * encuentra
	 * 
	 * @return La nueva coordenada
	 */
	...
	/**
	 * Mueve una celda en diagonal, hacia bajo a la derecha respecto a la que se
	 * encuentra
	 * 
	 * @return La nueva coordenada
	 */
	...
	/**
	 * Mueve una celda en diagonal, hacia bajo a la izquierda respecto a la que se
	 * encuentra
	 * 
	 * @return La nueva coordenada
	 */
